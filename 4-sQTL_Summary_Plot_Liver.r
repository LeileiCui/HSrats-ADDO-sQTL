...
# tradir = c("/SAN/mottlab/heterosis/3_HSrats/8_sQTL_Thu/0_Data/HSrats_fat_Trpts.phe")
# gendir = c("/SAN/mottlab/heterosis/3_HSrats/8_sQTL_Thu/0_Data/HSrats_fat_Genes.phe")
# plinkdir = c("/SAN/mottlab/heterosis/3_HSrats/8_sQTL_Thu/0_Data/HSrats_fat_Genes")
# plotdat = c("/SAN/mottlab/heterosis/3_HSrats/8_sQTL_Thu/3_sQTL/Plot_Fat/Plot_Fat.txt")

tradir = c("/SAN/mottlab/heterosis/3_HSrats/8_sQTL_Thu/0_Data/HSrats_liver_Trpts.phe")
gendir = c("/SAN/mottlab/heterosis/3_HSrats/8_sQTL_Thu/0_Data/HSrats_liver_Genes.phe")
plinkdir = c("/SAN/mottlab/heterosis/3_HSrats/8_sQTL_Thu/0_Data/HSrats_liver_Genes")
plotdat = c("/SAN/mottlab/heterosis/3_HSrats/8_sQTL_Thu/3_sQTL/Plot_Liver/Plot_Liver.txt")
...
for(i in 1:nrow(dat_plot)){
  ...
  for(j in 1:2){
    ...
    try({
      ...
      tmptrait = c(as.character(tmptrait_all[c(j, 3)]), paste0("chr", paste(tmptrait_all["T1_chr"], tmptrait_all["T1_pos"], sep="_")))
