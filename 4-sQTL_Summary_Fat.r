...
if(T){
	...
	write.table(gene_1trpts_res, file="Fat_1trpts.txt", row.names=F, col.names=T, quote=F)
...
if(T){
	...
	write.table(gene_2trpts_res, file="Fat_2trpts.txt", row.names=F, col.names=T, quote=F)
...
if(T){
	...
	write.table(gene_3trpts_res, file="Fat_3trpts.txt", row.names=F, col.names=T, quote=F)
