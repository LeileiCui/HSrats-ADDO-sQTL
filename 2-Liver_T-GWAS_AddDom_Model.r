...
outdir = "/SAN/mottlab/heterosis/3_HSrats/8_sQTL_Thu/2_Liver_Trpts"
Input_name = "HSrats_liver_Trpts"
...
ADDO_AddDom2_Pvalue(indir=indir, outdir=outdir, Input_name=Input_name, Kinship_type="GCTA_ad", VarComponent_Method="GCTA_ad", PheList_Choose=F, PheList=PheList, covariates_sum=44, Phe_IndMinimum=100, GT_IndMinimum=10, matrix_acceleration=T, num_nodes=10)
