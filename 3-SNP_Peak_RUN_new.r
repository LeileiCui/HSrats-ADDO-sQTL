...
out_dir = "/SAN/mottlab/heterosis/3_HSrats/8_sQTL_Thu/1_Fat_Genes/SNP_Peak"
rawdat_dir = "/SAN/mottlab/heterosis/3_HSrats/8_sQTL_Thu/0_Data/HSrats_fat_Genes"
pvalue_dir = "/SAN/mottlab/heterosis/3_HSrats/8_sQTL_Thu/1_Fat_Genes/2_Pvalue"
...
pvalue_choose = 4
	...
	try({
		...
		thrgenome = -log10(0.05/nrow(tmp_AD_raw)); thrsuggest = -log10(1/nrow(tmp_AD_raw))
