...
pos_info = read.table("/SAN/mottlab/heterosis/3_HSrats/8_sQTL_Thu/0_Data/KEY_Transcripts_Genes.txt", header=T)
# trpts_info = read.table("/SAN/mottlab/heterosis/3_HSrats/8_sQTL_Thu/1_Fat_Trpts/SNP_Peak/PeakSNP_AD_thrsuggest_EMMA_new.txt", header=T)
trpts_info = read.table("/SAN/mottlab/heterosis/3_HSrats/8_sQTL_Thu/2_Liver_Trpts/SNP_Peak/PeakSNP_AD_thrsuggest_EMMA_new.txt", header=T)
# gene_info = read.table("/SAN/mottlab/heterosis/3_HSrats/8_sQTL_Thu/1_Fat_Genes/SNP_Peak/PeakSNP_AD_thrsuggest_EMMA_new.txt", header=T)
gene_info = read.table("/SAN/mottlab/heterosis/3_HSrats/8_sQTL_Thu/2_Liver_Genes/SNP_Peak/PeakSNP_AD_thrsuggest_EMMA_new.txt", header=T)
...
if(T){
	...
	write.table(gene_1trpts_res, file="Liver_1trpts.txt", row.names=F, col.names=T, quote=F)
...
if(T){
	...
	write.table(gene_2trpts_res, file="Liver_2trpts.txt", row.names=F, col.names=T, quote=F)
...
if(T){
	...
	write.table(gene_3trpts_res, file="Liver_3trpts.txt", row.names=F, col.names=T, quote=F)
